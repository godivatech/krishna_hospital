...
export default function WhatsAppFloat() {
  ...
  useEffect(() => {
    // Small delay before showing the button so it doesn't pop in immediately on load
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-2">
      {/* Optional tooltip */}
      <div className="bg-white text-slate-700 text-sm font-medium py-2 px-4 rounded-xl shadow-lg border border-slate-100 animate-fade-in-up">
        Chat with us
      </div>
